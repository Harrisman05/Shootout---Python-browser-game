...
def gif_generation(gif, speed, gif_end_frame, gif_end_frame_sprite, goal = None, sound = None):
    ...
    while True:
        ...
        if clock() > nextFrame:
            ...
            if frame == gif_end_frame:
                ...
                single_player_loop()  # ending the gif and calling main_screen to go back to the selection screen
